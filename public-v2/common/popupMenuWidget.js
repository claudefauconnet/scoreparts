...
PopupMenuWidget.showPopup = function (point, popupDiv, options) {
  if (!options) {
    options = {};
  }
  if (!popupDiv) {
...
PopupMenuWidget.hidePopup = function (popupDiv) {
  if (PopupMenuWidget.blockHidePopup) {
    return (PopupMenuWidget.blockHidePopup = false);
  } //one shot
  if (!popupDiv) {
